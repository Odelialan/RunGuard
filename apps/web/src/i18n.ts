...
const ZH: Record<string, string> = {
  ...
  "Measured policy, evidence-security, and side-effect-free replay contracts.":
    "实际执行并测量策略、证据安全与无副作用重放契约。",
  "Establish the v1.0 baseline": "建立 v1.0 基线",
  "Execute 12 deterministic contracts against the current policy and security code.":
    "针对当前策略与安全代码执行 12 个确定性契约。",
  "Run baseline": "运行基线评测",
  "BASELINE SCORE": "基线评分",
  ...
  "Evidence security": "证据安全",
  "Recorded replay": "Recorded 重放",
  Efficiency: "效率",
  ...
  "Tool calls": "工具调用",
  Tokens: "Token 数",
  "Measured contract — scoped": "实测契约——范围明确",
  "The suite executes current policy, evidence sanitization, injection detection, and Recorded replay code. It does not claim live fault or model quality.":
    "该套件会执行当前策略、证据脱敏、注入检测与 Recorded 重放代码，但不宣称真实故障或模型质量。",
  "Scope and raw case results are recorded": "已记录评测范围和原始案例结果",
